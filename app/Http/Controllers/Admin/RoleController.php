    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $datatable = $datatable->addColumn('action', function($row)
            {
                ...
                if(have_right('roles-edit') && $row->id != 1 && auth()->user()->role_id != $row->id)
                {
                ...
                if(have_right('roles-delete') && $row->id != 1 && auth()->user()->role_id != $row->id)
                {
