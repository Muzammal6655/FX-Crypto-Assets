...
@section('sub-title', $action.' Sub Admin')
...
<div class="main-content">
	<div class="content-heading clearfix">
		<ul class="breadcrumb">
			...
			<li><a href="{{url('admin/sub-admins')}}"><i class="fa fa-user"></i>Sub Admins</a></li>
			<li>{{$action}}</li>
		</ul>
	</div>
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">{{$action}} Sub Admin</h3>
					</div>
					<div class="panel-body">
						@include('admin.messages')
						<form id="admins-form" class="form-horizontal label-left" action="{{url('admin/sub-admins')}}"
