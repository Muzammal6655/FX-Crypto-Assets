...
<div class="main-content">
	<div class="content-heading clearfix">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{url('admin/security-questions')}}"><i class="fa fa-product-hunt"></i>Security Question</a></li>
			<li>{{$action}}</li>
		</ul>
	</div>
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">{{$action}} Security Question</h3>
					</div>
					<div class="panel-body">
						@include('admin.messages')
						<form id="pools-form" class="form-horizontal label-left" action="{{url('admin/security-questions')}}" enctype="multipart/form-data" method="POST">
							@csrf
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="question"  class="form-control" required="" value="{{ ($action == 'Add') ? old('name') : $model->question}}">
								</div>
							</div>
							...
							<div class="text-right">
								<a href="{{url('admin/security-questions')}}">
