							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="number" name="min_deposits" class="form-control" required=""
										value="{{ ($action == 'Add') ? old('min_deposits') : number_format($model->min_deposits,4)}}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="number" name="max_deposits" class="form-control" required=""
										value="{{ ($action == 'Add') ? old('max_deposits') : number_format($model->max_deposits,4)}}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="number" name="profit_percentage" class="form-control" required=""
										value="{{ ($action == 'Add') ? old('profit_percentage') : number_format($model->profit_percentage,4)}}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="number" name="management_fee_percentage" class="form-control" required=""
										value="{{ ($action == 'Add') ? old('management_fee_percentage') : number_format($model->management_fee_percentage,4)}}">
								</div>
							</div>
