				...
				<form id="deposits-form" method="POST" action="{{url('/deposits')}}" enctype="multipart/form-data">
					...
					@if(!empty($pool_name))
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="pool_max_deposit"   value="{{ number_format($max_deposits,4) }}" readonly="">
						</div>
						<div class="form-group">
							<label for="pool_min_deposit">Pool Min Deposit</label>
							<input type="text" class="form-control" id="pool_min_deposit"  value="{{ number_format($min_deposits,4) }}" readonly="">
						</div>
					@endif
					<div class="form-group">
