            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <!-- comment textfield due to referral code size issue in mobile view -->
                        ...
                        <textarea rows="1" cols="20" class="form-control" id="referral_code" readonly="">{{ url('/register?ref='.Hashids::encode($user->id)) }}</textarea>
                    </div>
